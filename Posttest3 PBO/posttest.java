...
public class posttest {
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    addRegulerData(data, scanner);
                    break;
                case 2:
                    addPremiumData(data, scanner);
                    break;
                case 3:
                    showData(data);
                    break;
    ...
    private static void addRegulerData(ArrayList<Paket> data, Scanner scanner) {
        System.out.print("Masukkan nama paket reguler baru: ");
        String namaPaket = scanner.next();
        System.out.print("Masukkan harga paket reguler baru: ");
        double harga = scanner.nextDouble();
        PaketReguler paket = new PaketReguler(namaPaket, harga);
        data.add(paket);
        System.out.println("Data paket reguler baru berhasil ditambahkan.");
    }

    private static void addPremiumData(ArrayList<Paket> data, Scanner scanner) {
        System.out.print("Masukkan nama paket premium baru: ");
        String namaPaket = scanner.next();
        System.out.print("Masukkan harga paket premium baru: ");
        double harga = scanner.nextDouble();
        PaketPremium paket = new PaketPremium(namaPaket, harga);
        data.add(paket);
        System.out.println("Data paket premium baru berhasil ditambahkan.");
    }
